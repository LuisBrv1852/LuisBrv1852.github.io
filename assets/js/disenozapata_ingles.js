function revisarZapata() {
    ...
    let mensaje1 = "";
    if (q_dou <= qn_dou) {
        mensaje1 = "q is less than qn, therefore the dimensions are correct";
    } if (q_dou > qn_dou) {
        mensaje1 = "q is greater than qn, therefore Increase dimensions";
    }
    ...
    let mensaje3 = "";
    if ((B_dou / 6) >= ex) {
        mensaje2 = "Pass the flip in X";
    } if ((B_dou / 6) < ex) {
        mensaje2 = "Increase B";
    }
    if ((L_dou / 6) >= ey) {
        mensaje3 = "Pass the flip in Y";
    } if ((L_dou / 6) < ey) {
        mensaje3 = "Increase L";
    }
    ...
    if (aplicaMux === false) {
        aplicaMux_str = "Mux less than 0.2Vud, therefore it does not contribute to the penetration effort. ";
    }
    if (aplicaMuy === false) {
        aplicaMuy_str = "Muy less than 0.2Vud, therefore it does not contribute to the penetration effort. ";
    }
    ...
    if (VuPenetracion_dou <= VrcPenetracion_dou) {
        if (opcionZapata === 1) {
            mensaje4 = aplicaMux_str + aplicaMuy_str + "  The section resists the penetration effort";
        } else {
            mensaje4 = aplicaMux_str + aplicaMuy_str + " The section resists the penetration effort, " +
                "for a preserved design  " +
                "the ''g'' factors that reduce the moments are ignored";
        }
    } if (VuPenetracion_dou > VrcPenetracion_dou) {
        mensaje4 = "The section does not support the effort, increase h or the die";
    }
    ...
    if (B_dou < (4 * d_dou)) {
        RevElementoAncho1 = "Increase B.";
        elementoAncho = false;
    } if (L_dou < (4 * d_dou)) {
        RevElementoAncho2 = "Increase L.";
        elementoAncho = false;
    } if (h_dou > 0.6) {
        RevElementoAncho3 = "Decrease h less than 0.6 m.";
        elementoAncho = false;
    } if (interaccionMUx > 2) {
        RevElementoAncho4 = "Increase given in x or increase h.";
        elementoAncho = false;
    }
    if (interaccionMuy > 2) {
        RevElementoAncho5 = "Increase given in y or increase h.";
        elementoAncho = false;
    }
    let VrcCortante_dou = 0;
    if (elementoAncho) {
        VrcCortante_dou = 0.5 * 0.75 * 100 * (d_dou * 100) * Math.sqrt(f1c_dou) / 1000;
        mensaje5 = "Works as wide element";
    } else {
        let roVc = ro1;
        if (ro2 > roVc) {
            roVc = ro2;
        ...
        mensaje5 = "Works in shear as a concrete beam, it is considered ρ="
            + roVc_let + ". To work as a wide element, it is recommended: "
    ...
    if (VrcCortante_dou >= VuMax_dou) {
        mensaje6 = "Resists cutting";
    } else {
        mensaje6 = "Does not resist shear, increase h or die ";
    }
    ...
    if (h_dou >= 0.15) {
        mensaje7 = "The steel will be placed in 2 layers";
        factorAstMayorA15 = 0.5;
    } else {
        mensaje7 = "The steel will be placed in a single layer";
        factorAstMayorA15 = 1;
    }
    a[73] = mensaje7;
    ...
    if (Ast_dou <= AceroMax_dou) {
        mensaje8 = "In the lower bed the steel governs by bending";
    } else {
        mensaje8 = "In the lower bed the steel is governed by temperature";
    }
    ...
    resultadoLabel.innerHTML =
        "<h4>Check for load capacity</h4> <br>" +
        "" + mensaje1 + " <br>" +
        "<br><br><h4>Flip review</h4> <br>" +
        "" + mensaje2 + " <br>" +
        "" + mensaje3 + " <br>" +
        "<br><br><h4>Penetration review</h4> <br>" +
        ...
        "" + mensaje4 + "<br>" +
        "<br><br><h4>Flexion Design</h4> <br>" +
        "The rod will have the following separations <br>" +
        "In X to each " + separacionFlexionX.toFixed(2) + " cm <br>" + // <- Aquí había un punto y coma que interrumpía la cadena
        "In Y to each " + separacionFlexionY.toFixed(2) + " cm <br>" + // <- Aquí había un punto y coma que interrumpía la cadena
        "<br><br><h4>Shear design</h4> <br>" +
        "Vu=" + VuMax_dou.toFixed(2) + " ton<br>" +
        "" + mensaje5 + "<br>" +
        "Vrc=" + VrcCortante_dou.toFixed(2) + " ton <br>" +
        "" + mensaje6 + "<br>" +
        "<br><br><h4>Design by temperature</h4> <br>" +
        "" + mensaje7 + "<br>" +
        "" + mensaje8 + "<br>" +
        "The rod will be placed at each " + separacionTemperatura_int + " cm en ambas direcciones";
