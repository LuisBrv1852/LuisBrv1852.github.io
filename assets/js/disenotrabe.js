...
function calcularAS() {
    ...
    if (AceroPos_dou >= AceroPos) {
        mensaje1 = "Correcto, el acero propuesto es mayor";
    }
    if (AceroPos_dou < AceroPos) {
        mensaje1 = "Aumentar Acero";
    }
    ...
    if (AceroNeg_dou >= AceroNeg) {
        mensaje2 = "Correcto, el acero propuesto es mayor";
    }
    if (AceroNeg_dou < AceroNeg) {
        mensaje2 = "Aumentar Acero";
    }
    ...
    if (rev_por_cortante >= Vu_dou) {
        mensaje3 = "Cumple, Sección Correcta"
    } if (rev_por_cortante < Vu_dou) {
        mensaje3 = "No cumple, Aumentar sección";
    }
    a[32] = mensaje3;
    ...
    if(Vrc_dou>=Vu_dou){
        resistenciaConcreto="VRC>=Vu, El concreto resiste el cortante,requiere estribos por separación maxima";
    }if(Vu_dou>Vrc_dou){
        resistenciaConcreto="Vu>=VRC, Requiere estribos por resistencia"
    }
    ...
    if (asResultado_dou >= AvMin_dou) {
        mensaje4 = "Correcto as>Avmin";
    }
    if (asResultado_dou < AvMin_dou) {
        mensaje4 = "Aumentar diametro o ramales de Est";
    }
    ...
    resultadoLabel.innerHTML =
        ...
        "<br>" +
        "<h4>Revisión por flexión(+)</h4> <br><br>" +
        "q(+)=" + qpos.toFixed(3) + "<br>" +
    ...
    resultadolabel3.innerHTML =  "<br><br>"+      
        ...
        "Con el numero de varilla propuesto y numero de ramales Av="+asResultado_dou.toFixed(2)+"cm2<br>"+
        mensaje4+"<br>"+
        "<br><br>"+    
        "<h5>Separación por Vu</h5> <br><br>" +
