...
function revisionViga() {
    ...
    if (vigaSeccion_int <= 3) {
        ...
        alert("The section of the beam is 4, it is a slender beam, " +
        "it is recommended to change the section or shorten the length");
    }
    ...
    if (L_dou >= Lr_dou) {
        Mn_dou = Me_dou;
        tipoDeTrabajoFlexion_str = "Elastic lateral flexion and buckling";

    } if (Lu_dou < L_dou && L_dou < Lr_dou) {
        tipoDeTrabajoFlexion_str = "Flexion with inelastic lateral buckling";
        ...
        tipoDeTrabajoFlexion_str = "Flexion without lateral buckling";
        if (vigaSeccion_int <= 2) {
            Mn_dou = Mp_dou;
        } if (vigaSeccion_int <= 4 && vigaSeccion_int > 2) {
            Mn_dou = My_dou;
    ...
    "The beam works at "+porcentajeTrabajo_dou.toFixed(2)+"% % of its capacity ";
